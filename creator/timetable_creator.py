...
manually define row/column ranges for time slots, days.
"""
    ...
    try:
        ...
        if start_col <= end_col and day_ranges:
            ...
            try:
                ...
                st.warning(
                    f"Cannot preview time slots - please check your inputs. Error: {str(e)}"
                )
            ...
            if time_headers_slice.empty:
                ...
                for day_name, (start_row, end_row) in day_ranges.items():
                    ...
                    for col_idx, time_str in time_headers.items():
                        ...
                        final_json["timetable"][day_name][normalized_time] = (
                            class_entries
                        )
