...
def subject_name(subject_code: str, subject_json: dict) -> str:
    try:
        return subject_json[subject_code.strip()]
    except KeyError:
        return subject_code

def time_table_creator128(time_table_json: dict, subject_json: dict, batch: str, electives_subject_codes: list[str]) -> dict:
            ...
            for indi_class in classes:
                ...
                if not is_elective(extracted_batch=batchs):
                    if is_batch_included(batch, batchs):
                        your_time_table.append([day, time, subject_name(subject_json=subject, subject_code=code), indi_class.strip()[0], location_extractor(indi_class.strip())])
...
# 			"21B17CI573": "Software Engineering Lab",
...
#     print(json.dumps(time_table_creator(time_table, subjects, "F4", ["21B12CS312", "21B12CS317", "15B11CI513", "15B17CI573", "19B12HS613", "16B1NMA633", "20B16CS326"]), indent=4))
